  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main className="px-5 py-8 sm:px-8 lg:px-12">
        <section className="mx-auto grid min-h-[calc(100dvh-8.5rem)] w-full max-w-6xl items-center gap-10 lg:grid-cols-[1fr_420px]">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl break-keep text-pretty text-lg leading-8 text-zinc-700">
              Next.js App Router, TypeScript, Tailwind, Zod, React Hook Form 기반으로 바로 기능을
              얹을 수 있는 프론트엔드 시작점입니다.
            </p>
